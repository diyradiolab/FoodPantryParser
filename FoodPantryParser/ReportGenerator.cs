    ...
    public class ReportGenerator
    {
        ...
        private void CreateByAgencyReport(List<Order> allOrders)
        {
            ...
            foreach (var orderGroup in ordersByAgency)
            {
                ...
                GenericExcelReportGenerator.CreateReport(Path.Combine(ByAgencyOutputFolder, $"{reports[0].AgencyName}" + ".xlsx"), "Report", reports, $"Monthly Agency Report - {reports[0].AgencyName} - {CurrentMonth}/{CurrentYear}");
