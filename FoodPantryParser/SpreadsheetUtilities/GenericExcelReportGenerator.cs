...
{
    public static class GenericExcelReportGenerator
    {
        public static void CreateReport<T>(string filePath, string sheetName, List<T> data, string reportTitle)
        {
            ...
            using (var package = new ExcelPackage())
            {
                ...
                AddTotalsRow(worksheet, row, properties);
        ...
        private static void AddTotalsRow(ExcelWorksheet worksheet, int row, System.Reflection.PropertyInfo[] properties)
        {
